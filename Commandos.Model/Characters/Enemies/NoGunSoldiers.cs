...
{
    public class BlueMechanicGerman : EnemySoldier
    {
        public override string Name => "Blue Mechanic (German)";

        public override string Range => "500";
    ...
    {
        public override string Name => "Blue Soldier (German)";
    ...
    {
        public override string Name => "Mechanic (German)";
    ...
    {
        public override string Name => "Underwear Soldier (German)";

        public override string Range => "450";
    ...
    {
        public override string Name => "Towel Soldier (German)";
    ...
    {
        public override string Name => "Worker (German)";
    ...
    {
        public override string Name => "Atomic Worker (Japanese)";

        public override string Range => "400";
    ...
    {
        public override string Name => "Mechanic (Japanese)";
    ...
    {
        public override string Name => "Underwear Soldier (Japanese)";
    ...
    {
        public override string Name => "Towel Soldier (Japanese)";
    ...
    {
        public override string Name => "Big Hat Worker in Black (Japanese)";

        public override string Range => "550";
    ...
    {
        public override string Name => "Big Hat Worker in Green (Japanese)";
    ...
    {
        public override string Name => "Big Hat Worker in White (Japanese)";
